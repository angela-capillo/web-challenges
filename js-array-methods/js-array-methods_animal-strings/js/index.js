...
const catStartingFromIndexFiveExists = animalStrings.find((animal, index) => animal === "cat" && index >= 5 );
console.log(catStartingFromIndexFiveExists);

// Hint: Besides the array method, check out the string method `startsWith()`.
const firstAnimalStartingWithLetterP = animalStrings.findIndex((animal) => animal.startsWith("p"));
...
const sumOfAllAnimalCharacters = animalStrings.reduce((accumulator, animal) => accumulator + animal, "").length;
